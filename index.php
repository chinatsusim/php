...
<footer style="display:none;">
    <ul class="menu">
        <!-- <a href="javascript:void(0);" id="m00"><li><span class="material-symbols-outlined">home</span><br>Home</li></a> -->
        <!-- <a href="javascript:void(0);" id="m01"><li><span class="material-symbols-outlined">Explore</span><br>explore</li></a> -->
